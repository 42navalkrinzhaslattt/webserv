...
# URL to test
URL="http://localhost:8090/cgi-bin/crash.py"
...
for ((i=1; i<=$NUM_REQUESTS; i++)); do
    ...
    # If the status code is 500, increment the success counter
    # (We expect a 500 Internal Server Error for a crashing CGI script)
