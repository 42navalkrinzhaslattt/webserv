...
const string Errors::Config::MissingSemicolon(const string &directiveName) { return "Missing semicolon after directive: " + directiveName; }
...
const string Errors::Config::MissingBrace(const string &directiveName, const string &brace) {
    return "Missing " + brace + " in " + directiveName + " block";
}
